# 충남대학교 디자인창의학과 시각제품디자인전공 졸업전시 웹 프로젝트 계획서

## 프로젝트 개요

충남대학교 디자인창의학과 시각제품디자인전공 졸업전시 온라인 웹사이트 개발 프로젝트입니다. 웹 및 모바일 반응형 디자인을 지원하며, Next.js 기반으로 개발됩니다.
...
**작성일**: 2025년
**프로젝트명**: 충남대학교 디자인창의학과 시각제품디자인전공 졸업전시 웹
