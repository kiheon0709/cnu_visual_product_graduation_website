...
### 전체 크기
- 너비: **400px**
- 위치: 고정 (스크롤 시에도 좌측에 고정)

### 상단 로고 영역 (Frame 136)
- 위치: 좌측 상단
- 패딩: 상단에서 **46px**, 좌측에서 **46px**
- 높이: **74px**
...
**텍스트 스펙:**
1. 한글 타이틀: "충남대학교 디자인창의학과 시각제품디자인전공 졸업전시"
...
2. 영문 타이틀: "CNUD Graduation Exhibition Archive"
   - 폰트: Poppins SemiBold (600)
   - 크기: **12px**
   - 줄간격: **18px**
   - 자간: **-0.48px**
...
### 네비게이션 메뉴 (Frame 137)
- 위치: 로고 영역 아래
- 상단 간격: **536px** (로고 영역 하단 기준)
- 너비: **229px**
- 높이: **417px**

#### 메뉴 항목 (Frame 133)
- Project, Designer, Archive
- 각 항목 높이: **60px**
- 항목 간 간격: **111px** (첫 번째 항목 하단부터 다음 항목 상단까지)
